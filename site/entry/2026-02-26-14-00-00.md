...
所有している[Galaxy Z Fold7](https://www.samsung.com/jp/smartphones/galaxy-z-fold/)はインナーディスプレイが7.6インチあるので、
読む分には不都合はそれほどありません。
...
しかし現時点では[Snapdragon搭載端末には対応していない](https://developer.android.com/guide/topics/connectivity/linux-terminal)ようで、
