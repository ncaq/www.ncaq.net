...
updated: 2022-02-01T11:58:53+09:00
---
...
管理者権限で動かすにしても、
WindowsTerminalのタブ単位で管理者権限で実行は出来ないので、
新しいWindowsTerminalを管理者権限で動かす必要がありますし。
それは面倒です。
...
私はWindowsTerminalのショートカットでPowerShellのタブを開いてこれを実行しています。
...
Retrieving speedtest.net configuration...
Testing from J:COM (27.141.174.50)...
Retrieving speedtest.net server list...
Selecting best server based on ping...
