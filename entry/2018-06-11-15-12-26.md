---
title: ncurses 6.1にアップデートしたらatopなどのレイアウトが崩れる問題にはTERM環境変数を変えて対処すれば良いことがわかりました,原因を書きます
---
...
サンプルコードである`tparm(repeat_char, 'x', 10)`を打ち込んでも文字が全く増殖しない…
...
Konsoleはどうやらrepに対応することで対策したようですね.
